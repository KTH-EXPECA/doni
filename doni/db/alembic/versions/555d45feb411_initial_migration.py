...
def upgrade():
    ...
    op.create_table('availability_window',
        ...
        sa.ForeignKeyConstraint(['hardware_uuid'], ['hardware.uuid'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('availability_window_hardware_uuid_idx', 'availability_window', ['hardware_uuid'], unique=False)
    op.create_table('worker_task',
        ...
        sa.ForeignKeyConstraint(['hardware_uuid'], ['hardware.uuid'], ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('hardware_uuid', 'worker_type', name='uniq_workers0hardware_uuid0worker_type'),
...
def downgrade():
    ...
    op.drop_index('availability_window_hardware_uuid_idx', table_name='availability_window')
